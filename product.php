    ...
    <div class="container">
        <div class="side-nav">
            ...
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                    ...
                    <a href="">About</a>
                    <a href="">Contact</a>
                    <a onclick="displayProfile()">Account</a>
...
<!--               Hi!&nbsp;<span style="color:#ff523b;font-size:17px;"><b><?php echo $_POST["firstname"]; ?></b></span><br>-->
 ...
 <div class="product">
    ...
    <div class="cart" id="cart">
            <span style="font-size:30px;margin-left:70%;cursor: pointer;"   onclick="closecart()">&times;</span><br><br>
    ...
    <div class="openItems" id="openDetails" style="display:none;"><br>
            <div class="items-pic">
            ...
            <form>
                ...
                <br>
                <input type="number" class="select" min="0" style="width:35px;">
                &nbsp;&nbsp;&nbsp;
